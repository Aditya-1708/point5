    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          <h1 className="text-4xl font-bold font-display mb-4 text-foreground uppercase tracking-tighter">Service Not Found</h1>
          <Link to="/services" className="text-accent font-bold uppercase tracking-widest hover:underline">
            ← Back to Services
          </Link>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
              ...
              <div className="lg:col-span-8">
                <div className="mb-20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                    {[
                      ...
                      { icon: Trophy, label: "Premium Quality", val: "A+ Grade" },
                      { icon: Shield, label: "Full Support", val: "24/7 Access" },
                    ].map((item, i) => (
                      <motion.div
                        key={item.label}
                        initial={{ opacity: 0, y: 20 }}
                      ...
                      >
                        ...
                        <div className="text-[10px] uppercase tracking-widest text-foreground/40 font-bold mb-1">{item.label}</div>
                        <div className="text-sm font-bold uppercase tracking-wider text-foreground">{item.val}</div>
                      </motion.div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="space-y-6 mt-8">
                    {PROCESS_STEPS.slice(0, 3).map((step, i) => (
                      ...
                      >
                        ...
                        <div>
                          <h4 className="text-lg font-bold uppercase tracking-wider text-foreground mb-2">{step.title}</h4>
                          <p className="text-sm text-foreground/40 leading-relaxed italic">{step.desc}</p>
                        </div>
                      </motion.div>
                    ))}
                  </div>
                ...
                >
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold font-display uppercase tracking-tighter mb-6">Ready to scale your brand?</h3>
                  <Link
                    to="/contact"
              ...
              <div className="lg:col-span-4">
                <div className="sticky top-32">
                  ...
                  <div className="mt-12 p-8 glass rounded-3xl bg-accent/5 border-accent/10">
                    <h4 className="text-lg font-bold uppercase tracking-tight mb-4">Need Help Choosing?</h4>
                    <p className="text-sm text-foreground/50 mb-6 italic">Not sure which service fits your current stage? Schedule a free discovery call.</p>
                    <a href="mailto:point5media2022@gmail.com" className="text-accent font-bold uppercase text-xs tracking-widest hover:underline flex items-center gap-2">
